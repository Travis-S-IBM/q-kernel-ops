...
class TestUtils(TestCase):
    ...
    def test_known_exception(self):
        ...
        error_413 = """Failed to run program: '413 Client Error: Payload Too Large for url: 
        https://runtime-us-east.quantum-computing.ibm.com/jobs. <html>\\r\\n<head><title>413 Request Entity Too 
        ...
        error_rantoolong = """'("Connection broken: InvalidChunkLength(got length b\'\', 0 bytes read)", 
